                ...
                <div className={`p-8 rounded-2xl shadow-sm border space-y-8 leading-relaxed text-sm md:text-base ${darkmode ? "bg-slate-900 border-slate-800 text-slate-300" : "bg-white border-slate-100 text-slate-700"}`}>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-5 space-y-1 mt-2">
                            <li>Resume creation and editing interfaces.</li>
                            <li>AI-driven content suggestions and improvements.</li>
                            <li>Professional resume templates.</li>
                            <li>Download options in various formats (e.g., PDF).</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="mt-2">
                            We reserve the right to suspend or terminate accounts that suspect of unauthorized or fraudulent use.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="mt-2">
                            By using the Service, you grant us a license to process, store, and display your content solely for the purpose of providing the service to you. We do not sell your individual resume data to third parties.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-5 space-y-1 mt-2">
                            <li>AI suggestions may not be 100% accurate or suitable for every situation.</li>
                            <li>You are responsible for reviewing and verifying all content before using it for job applications.</li>
                            <li>We do not guarantee job placement, interview calls, or specific career outcomes based on the use of our tools.</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-5 space-y-1 mt-2">
                            ...
                            <li>Uploading content that is infringing, libelous, defamatory, obscene, or otherwise objectionable.</li>
                            <li>Attempting to hack, overload, or reverse engineer any part of the Service or its underlying AI models.</li>
                            <li>Selling, reselling, or exploiting any portion of the Service without express written permission.</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-5 space-y-1 mt-2">
                            ...
                            <li>Free tiers may be limited in features compared to paid subscriptions.</li>
                        </ul>
                    </section>
