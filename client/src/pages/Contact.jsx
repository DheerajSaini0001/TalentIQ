        ...
        <div className={`min-h-screen pt-20 pb-16 transition-colors duration-500 ${darkmode ? "bg-slate-950 text-slate-100" : "bg-slate-50 text-slate-900"}`}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
                        ...
                        <div className={`p-8 rounded-2xl shadow-sm border ${darkmode ? "bg-slate-900 border-slate-800" : "bg-white border-slate-100"}`}>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <p className={`text-sm font-medium ${darkmode ? "text-slate-200" : "text-slate-900"}`}>Email</p>
                                        <a href="mailto:dheerajsaini131652@gmail.com" className={`${darkmode ? "text-slate-400 hover:text-blue-400" : "text-slate-600 hover:text-blue-600"} transition-colors`}>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <p className={`text-sm font-medium ${darkmode ? "text-slate-200" : "text-slate-900"}`}>Phone</p>
                                        <a href="tel:+916375131652" className={`${darkmode ? "text-slate-400 hover:text-blue-400" : "text-slate-600 hover:text-blue-600"} transition-colors`}>
                                            +91 63751 31652
                                        </a>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <p className={`text-sm font-medium ${darkmode ? "text-slate-200" : "text-slate-900"}`}>Office</p>
                    ...
                    {/* Contact Form */}
                    <div className={`p-8 rounded-2xl shadow-lg shadow-slate-200/50 border ${darkmode ? "bg-slate-900 border-slate-800 shadow-none" : "bg-white border-slate-100"}`}>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                <label className={`block text-sm font-medium mb-1 ${darkmode ? "text-slate-300" : "text-slate-700"}`}>Subject</label>
                                <Input
                            ...
                            <div>
                                <label className={`block text-sm font-medium mb-1 ${darkmode ? "text-slate-300" : "text-slate-700"}`}>Message</label>
                                <textarea
                                    rows={4}
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none transition-all ${darkmode ? "bg-slate-800 border-slate-700 text-slate-100 placeholder:text-slate-500" : "bg-white border-slate-300 text-slate-900 placeholder:text-slate-400"}`}
