            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="md:flex md:items-center md:justify-between mb-8">
                    ...
                    <div className="mt-4 flex md:ml-4 md:mt-0">
                        <div className={`flex items-center space-x-2 text-sm ${darkmode ? "text-slate-400" : "text-slate-500"}`}>
                            {[1, 2, 3, 4, 5, 6].map((i) => (
                                <div key={i} className="flex items-center">
                                    <button
                                        type="button"
                                        onClick={() => setStep(i)}
                                        className={`flex h-6 w-6 items-center justify-center rounded-full text-xs font-bold transition-all hover:scale-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${step >= i ? 'bg-blue-600 text-white' : (darkmode ? 'bg-slate-800 text-slate-400 hover:bg-slate-700' : 'bg-slate-200 hover:bg-slate-300')}`}
                                    >
                                        {i}
                                    </button>
                                    {i < 6 && <div className={`h-0.5 w-4 mx-1 transition-colors duration-300 ${step > i ? 'bg-blue-600' : (darkmode ? 'bg-slate-800' : 'bg-slate-200')}`} />}
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div className={`shadow rounded-lg overflow-hidden transition-colors duration-500 ${darkmode ? "bg-slate-900 border border-slate-800" : "bg-white"}`}>
                    <form onSubmit={handleCreate} className="p-6 space-y-8">
                            ...
                            <div className="space-y-6 animate-fadeIn">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="w-full">
                                        <label className={`block text-sm font-medium leading-6 mb-2 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>Phone Number</label>
                                        <div className="relative flex rounded-md shadow-sm"><div className={`inline-flex items-center px-3 rounded-l-md border border-r-0 sm:text-sm ${darkmode ? "border-slate-800 bg-slate-900 text-slate-400" : "border-slate-300 bg-slate-50 text-slate-500"}`}><span className="mr-2 text-lg">🇮🇳</span><span>+91</span></div><input type="tel" name="phoneNumber" className={`flex-1 block w-full rounded-none rounded-r-md border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 ${darkmode ? "bg-slate-900 border-slate-800 text-slate-100 placeholder:text-slate-500" : "bg-white border-slate-300 text-slate-900"}`} placeholder="98765 43210" value={formData.phoneNumber} onChange={handleChange} required /></div>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-8 animate-fadeIn">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="md:col-span-2"><label className={`block text-sm font-medium leading-6 mb-2 ${darkmode ? "text-slate-200" : "text-slate-900"}`}>Key Strengths</label><textarea name="keyStrengths" rows={3} className={`block w-full rounded-md border-0 py-1.5 px-3  shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-blue-600 sm:text-sm ${darkmode ? "bg-slate-900 text-slate-100" : "bg-slate-50 text-slate-900"}`} placeholder="e.g. Project Management, React Specialist" value={formData.keyStrengths} onChange={handleChange} /></div>
                                        <div className="md:col-span-2"><label className={`block text-sm font-medium leading-6 mb-2 ${darkmode ? "text-slate-200" : "text-slate-900"}`}>Career Goal (Optional)</label><textarea name="careerGoal" rows={2} className={`block w-full rounded-md border-0 py-1.5 px-3  shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-blue-600 sm:text-sm ${darkmode ? "bg-slate-900 text-slate-100" : "bg-slate-50 text-slate-900"}`} placeholder="e.g. Seeking a challenging role..." value={formData.careerGoal} onChange={handleChange} /></div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-6 pt-6 border-t border-slate-200">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div><label className={`block text-sm font-medium leading-6 mb-2 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>Employment Type</label><select name="type" value={formData.latestJob.type} onChange={handleJobChange} className={`block w-full rounded-md border-0 py-2.5 px-3 ring-1 ring-inset focus:ring-2 focus:ring-blue-600 sm:text-sm ${darkmode ? "bg-slate-900 ring-slate-800 text-slate-100" : "text-slate-900 ring-slate-300"}`}><option value="Full-time">Full-time</option><option value="Part-time">Part-time</option><option value="Internship">Internship</option><option value="Contract">Contract</option><option value="Freelance">Freelance</option></select></div>
                                        <div><label className={`block text-sm font-medium leading-6 mb-2 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>Location Type</label><select name="location" value={formData.latestJob.location} onChange={handleJobChange} className={`block w-full rounded-md border-0 py-2.5 px-3 ring-1 ring-inset focus:ring-2 focus:ring-blue-600 sm:text-sm ${darkmode ? "bg-slate-900 ring-slate-800 text-slate-100" : "text-slate-900 ring-slate-300"}`}><option value="On-site">On-site</option><option value="Remote">Remote</option><option value="Hybrid">Hybrid</option></select></div>
                                        ...
                                        <div className="md:col-span-2">
                                            <div className="flex justify-between items-center mb-2">
                                                <label className={`block text-sm font-medium leading-6 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>Key Achievements</label>
                                                <button
                                                    type="button"
                                                    onClick={() => {
                                            ...
                                            <textarea name="achievements" rows={3} className={`block w-full rounded-md border-0 py-1.5 px-3 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-blue-600 sm:text-sm ${darkmode ? "bg-slate-900 ring-slate-800 text-slate-100 placeholder:text-slate-400" : "text-slate-900 ring-slate-300 placeholder:text-slate-400"}`} placeholder="e.g. Increased conversion by 20%" value={formData.latestJob.achievements} onChange={handleJobChange} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        {step === 3 && (
                            <div className="space-y-6 animate-fadeIn">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="md:col-span-2"><label className={`block text-sm font-medium leading-6 mb-2 ${darkmode ? "text-slate-200" : "text-slate-900"}`}>Relevant Coursework</label><textarea name="relevantCoursework" rows={3} className={`block w-full rounded-md border-0 py-1.5 px-3 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-blue-600 sm:text-sm ${darkmode ? "bg-slate-900 text-slate-100" : "bg-slate-50 text-slate-900"}`} placeholder="e.g. Data Structures, Algorithms" value={formData.education.relevantCoursework} onChange={handleEducationChange} /></div>
                                </div>
                            </div>
                        )}
                        ...
                        {step === 4 && (
                            <div className="space-y-6 animate-fadeIn">
                                ...
                                <div className={`p-4 rounded-lg border mb-6 transition-all ${darkmode ? "bg-slate-900 border-slate-800" : "bg-slate-50 border-slate-200"}`}>
                                    <label className={`block text-sm font-medium mb-2 ${darkmode ? "text-slate-300" : "text-slate-700"}`}>Explore Skills</label>
                                    ...
                                    <div className="relative mb-4">
                                        ...
                                        <input
                                            type="text"
                                            className={`block w-full rounded-md border-0 py-2.5 px-3 pl-10 pr-3 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-blue-600 sm:text-sm ${darkmode ? "bg-slate-950 ring-slate-800 text-slate-100 placeholder:text-slate-400" : "text-slate-900 ring-slate-300 placeholder:text-slate-400"}`}
                                    ...
                                    {!skillSearchTerm && (
                                        <div className="mb-4">
                                            <select
                                                className={`block w-full rounded-md border-0 py-2.5 px-3 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-blue-600 sm:text-sm ${darkmode ? "bg-slate-950 ring-slate-800 text-slate-100" : "text-slate-900 ring-slate-300"}`}
                                    ...
                                    {/* Results Area */}
                                    <div className={`rounded border max-h-60 overflow-y-auto custom-scrollbar p-1 ${darkmode ? "bg-slate-950 border-slate-800" : "bg-white border-slate-100"}`}>
                                                            ...
                                                            <div className="flex flex-wrap gap-2">
                                                                {matches.map(skill => (
                                                                    <button
                                                                        ...
                                                                        className={`inline-flex items-center px-2.5 py-1.5 px-3 rounded-full text-xs font-medium border transition-colors ${darkmode ? "bg-blue-900/20 text-blue-300 border-blue-900/50 hover:bg-blue-900/40" : "bg-blue-50 text-blue-700 hover:bg-blue-100 border-blue-200"}`}
                                                                    >
                                                ...
                                                <div className="p-3 flex flex-wrap gap-2">
                                                    {predefinedSkills[activeSkillCategory].map(skill => (
                                                        <button
                                                            ...
                                                            className="inline-flex items-center px-2.5 py-1.5 px-3 rounded-full text-xs font-medium bg-blue-50 text-blue-700 hover:bg-blue-100 border border-blue-200 transition-colors"
                                                        >
                                                            + {skill}
                                                        </button>
                                                    ))}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <textarea
                                            name="soft"
                                            rows={3}
                                            className={`block w-full rounded-md border-0 py-1.5 px-3 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-blue-600 sm:text-sm ${darkmode ? "bg-slate-900 ring-slate-800 text-slate-100 placeholder:text-slate-400" : "text-slate-900 ring-slate-300 placeholder:text-slate-400"}`}
                            ...
                            <div className="space-y-8 animate-fadeIn">
                                <div className="space-y-6">
                                    ...
                                    {formData.projects.map((proj, index) => (
                                        <div key={index} className={`relative p-4 rounded-lg border mb-4 ${darkmode ? "bg-slate-900 border-slate-800" : "bg-slate-50 border-slate-200"}`}>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                ...
                                                <div className="md:col-span-2">
                                                    <div className="flex justify-between items-center mb-2">
                                                        <label className={`block text-sm font-medium leading-6 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>Description</label>
                                                        <button
                                                            type="button"
                                                            onClick={() => {
                                                    ...
                                                    <textarea name="description" rows={3} className={`block w-full rounded-md border-0 py-1.5 px-3 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-blue-600 sm:text-sm ${darkmode ? "bg-slate-950 ring-slate-800 text-slate-100 placeholder:text-slate-400" : "text-slate-900 ring-slate-300 placeholder:text-slate-400"}`} placeholder="Brief description of what you built..." value={proj.description} onChange={(e) => handleArrayChange('projects', index, e)} />
                                                </div>
                                            </div>
                                        </div>
                                    ))}
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="md:col-span-2">
                                            ...
                                            <textarea name="description" rows={2} className={`block w-full rounded-md border-0 py-1.5 px-3 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-blue-600 sm:text-sm ${darkmode ? "bg-slate-900 ring-slate-800 text-slate-100 placeholder:text-slate-400" : "text-slate-900 ring-slate-300 placeholder:text-slate-400"}`} placeholder="e.g. Ranked 1st among 500 participants..." value={formData.achievement.description} onChange={(e) => handleNestedChange('achievement', e)} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="space-y-8 animate-fadeIn">
                                        ...
                                        {formData.internships.map((intern, index) => (
                                            <div key={index} className={`relative p-4 rounded-lg border mb-4 ${darkmode ? "bg-slate-900 border-slate-800" : "bg-slate-50 border-slate-200"}`}>
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                    ...
                                                    <div className="md:col-span-2">
                                                        <div className="flex justify-between items-center mb-2">
                                                            <label className={`block text-sm font-medium leading-6 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>Key Learnings / Description</label>
                                                            <button
                                                                type="button"
                                                                onClick={() => {
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div>
                                                <label className={`block text-sm font-medium leading-6 mb-2 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>Proficiency</label>
                                                <select name="proficiency" value={formData.language.proficiency} onChange={(e) => handleNestedChange('language', e)} className={`block w-full rounded-md border-0 py-2.5 px-3 ring-1 ring-inset focus:ring-2 focus:ring-blue-600 sm:text-sm ${darkmode ? "bg-slate-900 ring-slate-800 text-slate-100" : "text-slate-900 ring-slate-300"}`}>
                                    ...
                                    <div className="space-y-6">
                                            ...
                                            {['hobbies', 'volunteering', 'publications'].map((section) => (
                                                <button
                                                    ...
                                                    className={`px-4 py-2 rounded-full text-sm font-medium border transition-colors capitalize ${extraSections[section]
                                                        ...
                                                        : (darkmode ? 'bg-slate-900 text-slate-300 border-slate-700 hover:bg-slate-800' : 'bg-white text-slate-700 border-slate-300 hover:bg-slate-50')
                                                        }`}
                                                >
                                        ...
                                        {extraSections.volunteering && (
                                            <div className="animate-fadeIn">
                                                <label className={`block text-sm font-medium leading-6 mb-2 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>Volunteering Experience</label>
                                                <textarea name="volunteering" rows={3} className={`block w-full rounded-md border-0 py-1.5 px-3 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-blue-600 sm:text-sm ${darkmode ? "bg-slate-900 ring-slate-800 text-slate-100 placeholder:text-slate-400" : "text-slate-900 ring-slate-300 placeholder:text-slate-400"}`} placeholder="Describe your volunteering roles..." value={formData.extras.volunteering} onChange={(e) => handleNestedChange('extras', e)} />
                                            </div>
                                        )}
                        ...
                        <div className={`flex items-center justify-end gap-x-4 pt-4 border-t ${darkmode ? "border-slate-800" : "border-slate-100"}`}>
                ...
                {/* AI Writer Modal */}
                {
                    aiModalOpen && (
                        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-fadeIn">
                            <div className={`rounded-xl shadow-2xl w-full max-w-lg overflow-hidden border ${darkmode ? "bg-slate-900 border-slate-700" : "bg-white border-slate-200"}`}>
                                <div className={`p-4 border-b flex justify-between items-center ${darkmode ? "bg-purple-900/20 border-slate-700" : "bg-purple-50 border-slate-100"}`}>
                                    ...
                                    <button onClick={() => setAiModalOpen(false)} className={`hover:text-slate-600 ${darkmode ? "text-slate-500" : "text-slate-400"}`}>
                                        <X className="w-5 h-5" />
                                    </button>
                                </div>
                                ...
                                <div className="p-6 space-y-4">
                                    {!aiResults.length && (
                                        <div>
                                            ...
                                            <textarea
                                                className={`w-full rounded-md shadow-sm focus:border-purple-500 focus:ring-purple-500 min-h-[100px] text-sm ${darkmode ? "bg-slate-950 border-slate-700 text-slate-100" : "border-slate-300"}`}
                                            ...
                                            <div className="space-y-2 max-h-[300px] overflow-y-auto pr-1">
                                                {aiResults.map((res, idx) => (
                                                    <div
                                                        ...
                                                        className={`p-3 rounded border hover:border-purple-300 hover:bg-purple-50 cursor-pointer transition-all group ${darkmode ? "bg-slate-950 border-slate-700 hover:bg-purple-900/20" : "border-slate-200"}`}
                                                    >
                                                        <div className="flex gap-3">
                                                            ...
                                                            <p className={`text-sm leading-relaxed ${darkmode ? "text-slate-300" : "text-slate-700"}`}>{res.replace(/^[•-]\s*/, '')}</p>
                                                        </div>
                                                    </div>
                                                ))}
                                            </div>
                                ...
                                {!aiResults.length && !aiLoading && (
                                    <div className={`p-4 border-t flex justify-end gap-3 ${darkmode ? "bg-slate-900 border-slate-800" : "bg-slate-50 border-slate-100"}`}>
