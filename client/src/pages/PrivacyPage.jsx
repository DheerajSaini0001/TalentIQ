        ...
        <div className={`min-h-screen pt-20 pb-16 transition-colors duration-500 ${darkmode ? "bg-slate-950 text-slate-100" : "bg-slate-50 text-slate-900"}`}>
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-12">
                    ...
                    <p className={`${darkmode ? "text-slate-400" : "text-slate-500"}`}>Effective Date: January 29, 2026</p>
                </div>
                ...
                <div className={`p-8 rounded-2xl shadow-sm border space-y-8 leading-relaxed text-sm md:text-base ${darkmode ? "bg-slate-900 border-slate-800 text-slate-300" : "bg-white border-slate-100 text-slate-700"}`}>
                    ...
                    <section>
                        <h2 className={`text-xl font-bold mb-3 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>1. Information Collection</h2>

                        <div className={`pl-4 border-l-2 space-y-4 ${darkmode ? "border-slate-800" : "border-slate-100"}`}>
                            <div>
                                <h3 className={`font-semibold ${darkmode ? "text-slate-100" : "text-slate-900"}`}>1.1. Personal Data</h3>
                            ...
                            <div>
                                <h3 className={`font-semibold ${darkmode ? "text-slate-100" : "text-slate-900"}`}>1.2. Account Credentials</h3>
                            ...
                            <div>
                                <h3 className={`font-semibold ${darkmode ? "text-slate-100" : "text-slate-900"}`}>1.3. Usage Data</h3>
                    ...
                    <section>
                        <h2 className={`text-xl font-bold mb-3 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>2. Use of Data</h2>
                        ...
                        <div className={`mt-4 p-3 border rounded-lg text-sm font-medium ${darkmode ? "bg-slate-800 border-slate-700 text-slate-300" : "bg-slate-50 border-slate-200 text-slate-800"}`}>
                    ...
                    <section>
                        <h2 className={`text-xl font-bold mb-3 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>3. AI Processing & Disclaimer</h2>
                    ...
                    <section>
                        <h2 className={`text-xl font-bold mb-3 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>4. Intellectual Property & Data Ownership</h2>
                    ...
                    <section>
                        <h2 className={`text-xl font-bold mb-3 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>5. Data Security</h2>
                    ...
                    <section>
                        <h2 className={`text-xl font-bold mb-3 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>6. Third-Party Service Providers</h2>
                    ...
                    <section>
                        <h2 className={`text-xl font-bold mb-3 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>7. Cookies Policy</h2>
                    ...
                    <section>
                        <h2 className={`text-xl font-bold mb-3 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>8. Data Retention</h2>
                        <p>We will retain your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes, and enforce our legal agreements and policies.</p>
                    </section>

                    <section>
                        <h2 className={`text-xl font-bold mb-3 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>9. User Rights</h2>
                    ...
                    <section>
                        <h2 className={`text-xl font-bold mb-3 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>10. Children's Privacy</h2>
                        <p>
                    ...
                    <section>
                        <h2 className={`text-xl font-bold mb-3 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>11. Changes to This Privacy Policy</h2>
                        <p>
                    ...
                    <section>
                        <h2 className={`text-xl font-bold mb-3 ${darkmode ? "text-slate-100" : "text-slate-900"}`}>12. Contact Information</h2>
                        <p className="mb-3">
                            If you have any questions about this Privacy Policy, please contact us:
                        </p>
                        <div className={`p-6 rounded-lg border inline-block pr-12 ${darkmode ? "bg-slate-800 border-slate-700" : "bg-slate-50 border-slate-200"}`}>
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className={`${darkmode ? "text-slate-300" : "text-slate-700"}`}>TalentIQ</span>
                                </div>
                            </div>
                        </div>
                    </section>
